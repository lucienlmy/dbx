...
export default withEnglishFallback({
  ...
  settings: {
    ...
    queryResultMaxRowsUnlimitedDescription: "Nessun limite totale di righe o di caricamento continuo. I risultati grandi possono usare molta memoria.",
