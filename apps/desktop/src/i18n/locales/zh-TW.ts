...
export default withEnglishFallback({
  ...
  connection: {
    ...
    consulTokenPlaceholder: "選填的 Consul ACL Token",
    ...
    consulAgentTargetHint: "Agent 寫入操作必填。DNS/負載均衡和 Transport Layer 連線維持唯讀。",
    consulMeshFeatures: "服務網格",
    consulMeshVisible: "顯示服務網格進階功能",
    consulMeshVisibleHint: "僅在需要管理 Connect、服務意圖或對等連線時開啟；關閉後主導覽不會顯示服務網格。",
    consulOperatorWrites: "Operator 寫入",
    consulOperatorVisible: "顯示實驗性 Operator 工作台",
    consulOperatorSnapshotRestore: "啟用 Snapshot 還原",
    consulOperatorAutopilot: "啟用 Autopilot 修改",
    consulOperatorRaft: "啟用 Raft 修改",
    consulOperatorKeyring: "啟用 Keyring 修改",
    consulOperatorLicense: "啟用 License 修改",
  ...
  settings: {
    ...
    queryResultMaxRowsUnlimitedDescription: "不限制傳回總列數或連續捲動累計數量，大型結果集可能占用大量記憶體。",
